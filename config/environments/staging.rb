Rails.application.configure do
  ...
  # Cloudflare is handling SSL, turn off here.
  ...
  config.active_job.queue_name_prefix = "ptil_rails_staging"
  ...
  # config.active_record.queues.destroy = :default
